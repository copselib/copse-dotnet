...
// syntax adapted to C# 7.3 (nullable annotations removed). Semantics unchanged, including
// Rx's thread-safety, retained deliberately even though Copse is single-threaded by
// contract. See THIRD-PARTY-NOTICES.md.
