...
namespace Copse.Treenumerators
{
  ...
  /// still capturing from a feed fills just in time while an already-buffered answer
  ...
  internal sealed class PreorderStoreDepthFirstTreenumerator<TNode, TStore>
