namespace Copse.CodeGen
{
  ...
  public static class GeneratorManifest
  {
    ...
    public static readonly GeneratorEntry[] Entries =
    {
      ...
      new("Copse.Linq.Async/Topologies/AsyncWalkableTopology.cs",
        "Copse.Linq/Topologies/WalkableTopology.g.cs",
        "AsyncWalkableTopology", "WalkableTopology", "Copse.Linq.Topologies"),
      new("Copse.Linq.Async/Topologies/AsyncWalkerTopology.cs",
        "Copse.Linq/Topologies/WalkerTopology.g.cs",
        "AsyncWalkerTopology", "WalkerTopology", "Copse.Linq.Topologies"),
