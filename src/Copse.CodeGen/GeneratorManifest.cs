namespace Copse.CodeGen
{
  ...
  public static class GeneratorManifest
  {
    ...
    public static readonly GeneratorEntry[] Entries =
    {
      ...
      new("Copse.Linq.Async/Treenumerables/Walkable/AsyncDoorTopology.cs",
        "Copse.Linq/Treenumerables/Walkable/DoorTopology.g.cs",
        "AsyncDoorTopology", "DoorTopology", "Copse.Linq.Treenumerables"),
