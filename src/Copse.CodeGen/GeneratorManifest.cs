namespace Copse.CodeGen
{
  ...
  public static class GeneratorManifest
  {
    public static readonly GeneratorEntry[] Entries =
    {
      ...
      new("Copse.Linq.Async/Treenumerables/WhereResultSelector.cs",
        "Copse.Linq/Treenumerables/WhereResultSelector.g.cs",
        "WhereResultSelector", "WhereResultSelector", "Copse.Linq.Treenumerables"),

      new("Copse.Linq.Async/Treenumerables/PositionalWhereResultSelector.cs",
        "Copse.Linq/Treenumerables/PositionalWhereResultSelector.g.cs",
        "PositionalWhereResultSelector", "PositionalWhereResultSelector", "Copse.Linq.Treenumerables"),

      new("Copse.Linq.Async/Treenumerables/PruneBeforeResultSelector.cs",
        "Copse.Linq/Treenumerables/PruneBeforeResultSelector.g.cs",
        "PruneBeforeResultSelector", "PruneBeforeResultSelector", "Copse.Linq.Treenumerables"),

      new("Copse.Linq.Async/Treenumerables/FuncResultSelector.cs",
        "Copse.Linq/Treenumerables/FuncResultSelector.g.cs",
      ...
      new("Copse.Linq.Async/Treenumerables/PositionalPruneBeforeResultSelector.cs",
