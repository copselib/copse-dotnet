namespace Copse.CodeGen
{
  ...
  public static class GeneratorManifest
  {
    ...
    public static readonly GeneratorEntry[] Entries =
    {
      ...
      new("Copse.Linq.Async/Treenumerables/Buffers/AsyncScanFoldPass.cs",
        "Copse.Linq/Treenumerables/Buffers/ScanFoldPass.g.cs",
        "AsyncScanFoldPass", "ScanFoldPass", "Copse.Linq.Treenumerables"),
      new("Copse.Linq.Async/Treenumerables/Buffers/AsyncScanProductBuffer.cs",
        "Copse.Linq/Treenumerables/Buffers/ScanProductBuffer.g.cs",
        "AsyncScanProductBuffer", "ScanProductBuffer", "Copse.Linq.Treenumerables"),
