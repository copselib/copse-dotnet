namespace Copse.CodeGen
{
  ...
  public static class GeneratorManifest
  {
    ...
    public static readonly GeneratorEntry[] Entries =
    {
      ...
      new("Copse.Linq.Async/WalkableTreenumerable/AsyncWalkableTreenumerable.Extend.cs",
        "Copse.Linq/WalkableTreenumerable/WalkableTreenumerable.Extend.g.cs",
        "AsyncWalkableTreenumerable", "WalkableTreenumerable", "Copse.Linq"),
      new("Copse.Linq.Async/WalkableTreenumerable/AsyncWalkableTreenumerable.Subtrees.cs",
        "Copse.Linq/WalkableTreenumerable/WalkableTreenumerable.Subtrees.g.cs",
        "AsyncWalkableTreenumerable", "WalkableTreenumerable", "Copse.Linq"),
      new("Copse.Linq.Async/WalkableTreenumerable/AsyncWalkableTreenumerable.GetHandles.cs",
        "Copse.Linq/WalkableTreenumerable/WalkableTreenumerable.GetHandles.g.cs",
        "AsyncWalkableTreenumerable", "WalkableTreenumerable", "Copse.Linq"),
      new("Copse.Linq.Async/WalkableTreenumerable/AsyncWalkableTreenumerable.WalkerAt.cs",
        "Copse.Linq/WalkableTreenumerable/WalkableTreenumerable.WalkerAt.g.cs",
        "AsyncWalkableTreenumerable", "WalkableTreenumerable", "Copse.Linq"),
      ...
      new("Copse.Linq.Async/Treenumerable/AsyncTreenumerable.LeaffixDispatch.cs",
        "Copse.Linq/Treenumerable/Treenumerable.LeaffixDispatch.g.cs",
        "AsyncTreenumerable", "Treenumerable", "Copse.Linq"),
      ...
      new("Copse.Linq.Async/Treenumerable/AsyncTreenumerable.RootfixDispatch.cs",
