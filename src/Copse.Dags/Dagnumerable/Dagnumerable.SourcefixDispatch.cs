...
namespace Copse.Dags
{
  ...
  /// write-handles). For the VIRTUAL SOURCE FAMILY's invocation the subject is
  ...
  /// inside the dag; a dispatcher-less arrival is the in-band arrived-from-outside test).
  /// </summary>
