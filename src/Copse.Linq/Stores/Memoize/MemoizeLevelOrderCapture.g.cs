// <auto-generated>
//   Generated from AsyncMemoizeLevelOrderCapture.cs by Copse.CodeGen (async->sync transcription).
...
namespace Copse.Linq.Stores
{
  ...
  internal sealed class MemoizeLevelOrderCapture<TNode> : IDisposable
  {
    public MemoizeLevelOrderCapture(Func<ITreenumerator<TNode>> feedFactory)
    {
    ...
    {
      public Handle(MemoizeLevelOrderCapture<TNode> buffer)
      {
        _Buffer = buffer;
      }
