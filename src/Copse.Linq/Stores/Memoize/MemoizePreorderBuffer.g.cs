// <auto-generated>
//   Generated from AsyncMemoizePreorderBuffer.cs by Copse.CodeGen (async->sync transcription).
...
namespace Copse.Linq.Stores
{
  ...
  internal sealed class MemoizePreorderBuffer<TValue> : IDisposable
  {
    public MemoizePreorderBuffer(Func<ITreenumerator<TValue>> feedFactory)
    {
    ...
    {
      public Handle(MemoizePreorderBuffer<TValue> buffer)
      {
        _Buffer = buffer;
      }
