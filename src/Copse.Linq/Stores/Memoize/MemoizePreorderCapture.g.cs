// <auto-generated>
//   Generated from AsyncMemoizePreorderCapture.cs by Copse.CodeGen (async->sync transcription).
...
namespace Copse.Linq.Stores
{
  ...
  internal sealed class MemoizePreorderCapture<TNode> : IDisposable
  {
    public MemoizePreorderCapture(Func<ITreenumerator<TNode>> feedFactory)
    {
    ...
    {
      public Handle(MemoizePreorderCapture<TNode> buffer)
      {
        _Buffer = buffer;
      }
