// <auto-generated>
//   Generated from AsyncTreenumerable.ToFormattedLines.cs by Copse.CodeGen (async->sync transcription).
...
namespace Copse.Linq
{
  public static partial class Treenumerable
  {
    ...
    /// finite sources only.
    /// </summary>
    public static IReadOnlyList<string> ToFormattedLines<TNode>(this IDepthFirstTreenumerable<TNode> source)
    {
    ...
    public static IReadOnlyList<string> ToFormattedLines<TNode>(
