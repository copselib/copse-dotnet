...
namespace Copse.Linq
{
  public static partial class Treenumerable
  {
    ...
    /// Deferred (nothing is pulled until a replay or <c>Consume</c> demands it), so it keeps
    ...
    ///
    /// <para>Idempotent on a live memo: memoizing an <see cref="IMemoizeTreenumerableBuffer{TNode}"/>
    ...
    /// <see cref="ITreenumerableBuffer{TNode}"/> -- what Materialize returns) is NOT
    ...
    /// </summary>
    public static IMemoizeTreenumerableBuffer<TNode> Memoize<TNode>(this ITreenumerable<TNode> source)
      => source as IMemoizeTreenumerableBuffer<TNode> ?? new MemoizeTreenumerable<TNode>(source);
    ...
    /// buffer idempotency.
    /// </summary>
    public static IMemoizeTreenumerableBuffer<TNode> Memoize<TNode>(this IDepthFirstTreenumerable<TNode> source)
      => source is ITreenumerable<TNode> fullCitizen
        ? fullCitizen.Memoize()
        : new MemoizeDepthFirstSourceTreenumerable<TNode>(source);
    ...
    /// </summary>
    public static IMemoizeTreenumerableBuffer<TNode> Memoize<TNode>(this IBreadthFirstTreenumerable<TNode> source)
      => source is ITreenumerable<TNode> fullCitizen
        ? fullCitizen.Memoize()
        : new MemoizeBreadthFirstSourceTreenumerable<TNode>(source);
  }
}
