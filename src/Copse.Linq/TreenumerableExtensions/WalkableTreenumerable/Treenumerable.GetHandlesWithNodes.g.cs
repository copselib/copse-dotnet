// <auto-generated>
//   Generated from AsyncTreenumerable.GetHandlesWithNodes.cs by Copse.CodeGen (async->sync transcription).
...
namespace Copse.Linq
{
  public static partial class Treenumerable
  {
    ...
    /// </summary>
    public static IEnumerable<HandleAndNode<THandle, TNode>> GetHandlesWithNodes<TNode, THandle>(
      this IWalkableTreenumerable<TNode, THandle> source)
    {
      ...
      while (pending.Count > 0)
      {
        ...
        yield return new HandleAndNode<THandle, TNode>(stance.Focus, stance.GetNode());
