...
{
  /// <summary>
  /// Depth-first filter driver and the codegen source of truth for its sync twin:
  ...
  /// </summary>
  internal sealed class WhereDepthFirstTreenumerator<TSource, TResult, TResultSelector>
