...
namespace Copse.Linq.Treenumerables
{
  ...
  internal sealed partial class PruneAfterDepthFirstTreenumerable<TNode> : ISelectWhereDepthFirstTreenumerable<TNode>
  {
    ...
    bool ISelectWhereDepthFirstTreenumerable<TNode>.Relabels => false;
    ...
    {
      return new SelectPruneAfterDepthFirstTreenumerable<TNode, TOuterResult, ComposedResultSelector<TNode, TNode, TOuterResult, PruneAfterResultSelector<TNode>, SelectResultSelector<TNode, TOuterResult>>>(
        _Source,
