...
namespace Copse.Linq.Treenumerables
{
  ...
  internal interface IComposableTreenumerable<TNode> : ITreenumerable<TNode>
  {
    ...
    ITreenumerable<TOuterResult> ComposeSelect<TOuterResult>(Func<NodeContext<TNode>, TOuterResult> selector);
    ...
    ITreenumerable<TNode> ComposeFilter(Func<NodeContext<TNode>, CompositionResult<TNode>> stage, bool relabels);
  }
}
