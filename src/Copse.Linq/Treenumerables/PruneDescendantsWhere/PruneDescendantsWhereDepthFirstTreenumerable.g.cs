// <auto-generated>
//   Generated from AsyncPruneDescendantsWhereDepthFirstTreenumerable.g.cs by Copse.CodeGen (async->sync transcription).
...
namespace Copse.Linq.Treenumerables
{
  ...
  /// </summary>
  internal sealed partial class PruneDescendantsWhereDepthFirstTreenumerable<TNode> : ISelectWhereDepthFirstTreenumerable<TNode>
  {
    /// <summary>Wraps <paramref name="source"/> with a prune-after predicate.</summary>
    public PruneDescendantsWhereDepthFirstTreenumerable(
    ...
    IDepthFirstTreenumerable<TOuterResult> ISelectWhereDepthFirstTreenumerable<TNode>.Compose<TOuterResult, TOuterSelector>(
      ...
      bool relabels)
    {
      return new SelectWhereDepthFirstTreenumerable<TNode, TOuterResult, ComposedResultSelector<TNode, TNode, TOuterResult, PruneDescendantsWhereResultSelector<TNode>, TOuterSelector>>(
        _Source,
