...
namespace Copse.Linq.Treenumerables
{
  ...
  internal sealed partial class PruneDescendantsWhereBreadthFirstTreenumerable<TNode> : ISelectWhereBreadthFirstTreenumerable<TNode>
  {
    ...
    IBreadthFirstTreenumerable<TOuterResult> ISelectWhereBreadthFirstTreenumerable<TNode>.ComposePositional<TOuterResult>(Func<NodeContext<TNode>, TOuterResult> selector)
    ...
    IBreadthFirstTreenumerable<TNode> ISelectWhereBreadthFirstTreenumerable<TNode>.ComposePruneDescendantsWhere(Func<NodeContext<TNode>, bool> outerPredicate)
    {
