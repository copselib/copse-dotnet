// <auto-generated>
//   Generated from IAsyncSelectWhereBreadthFirstTreenumerable.g.cs by Copse.CodeGen (async->sync transcription).
//   Do not edit; edit the async source and regenerate: dotnet run --project Copse.CodeGen
// </auto-generated>
// <auto-generated>
//   Generated from ISelectWhereTreenumerable.cs by Copse.CodeGen (composite->narrow transcription).
...
namespace Copse.Linq.Treenumerables
{
  ...
  internal interface ISelectWhereBreadthFirstTreenumerable<TNode>
    ...
    IBreadthFirstTreenumerable<TOuterResult> Compose<TOuterResult, TOuterSelector>(
    ...
    IBreadthFirstTreenumerable<TOuterResult> Compose<TOuterResult>(Func<NodeAndPosition<TNode>, TOuterResult> selector);
    ...
    IBreadthFirstTreenumerable<TOuterResult> ComposePositional<TOuterResult>(Func<NodeAndPosition<TNode>, TOuterResult> selector);

    IBreadthFirstTreenumerable<TOuterResult> ComposePositional<TOuterResult, TOuterSelector>(
      TOuterSelector outerSelector,
      bool relabels)
      where TOuterSelector : struct, IResultSelector<TNode, TOuterResult>;
    ...
    IBreadthFirstTreenumerable<TNode> ComposePruneDescendantsWhere(Func<NodeAndPosition<TNode>, bool> predicate);
  }
}
