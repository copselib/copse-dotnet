// <auto-generated>
//   Generated from AsyncSelectWhereBreadthFirstTreenumerable.g.cs by Copse.CodeGen (async->sync transcription).
...
namespace Copse.Linq.Treenumerables
{
  ...
  internal sealed partial class SelectWhereBreadthFirstTreenumerable<TSource, TResult, TResultSelector> : ISelectWhereBreadthFirstTreenumerable<TResult>
    where TResultSelector : struct, IResultSelector<TSource, TResult>
  {
    ...
    public IBreadthFirstTreenumerable<TOuterResult> Compose<TOuterResult>(Func<NodeAndPosition<TResult>, TOuterResult> selector)
    ...
    private SelectWhereBreadthFirstTreenumerable<TSource, TOuterResult, ComposedResultSelector<TSource, TResult, TOuterResult, TResultSelector, TOuterSelector>> Splice<TOuterResult, TOuterSelector>(
      TOuterSelector outerSelector)
      where TOuterSelector : struct, IResultSelector<TResult, TOuterResult>
      => new SelectWhereBreadthFirstTreenumerable<TSource, TOuterResult, ComposedResultSelector<TSource, TResult, TOuterResult, TResultSelector, TOuterSelector>>(
        _Source,
    ...
    // labels.
    public IBreadthFirstTreenumerable<TOuterResult> ComposePositional<TOuterResult>(Func<NodeAndPosition<TResult>, TOuterResult> selector)
    ...
    public IBreadthFirstTreenumerable<TResult> ComposePruneDescendantsWhere(Func<NodeAndPosition<TResult>, bool> predicate)
      => new PruneDescendantsWhereBreadthFirstTreenumerable<TResult>(this, predicate);
  }
}
