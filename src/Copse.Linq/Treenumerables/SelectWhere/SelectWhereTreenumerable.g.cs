...
namespace Copse.Linq.Treenumerables
{
    ...
    where TResultSelector : struct, IResultSelector<TSource, TResult>
  {
    ...
    private SelectWhereTreenumerable<TSource, TOuterResult, ComposedResultSelector<TSource, TResult, TOuterResult, TResultSelector, TOuterSelector>> Splice<TOuterResult, TOuterSelector>(
      TOuterSelector outerSelector)
      where TOuterSelector : struct, IResultSelector<TResult, TOuterResult>
      => new SelectWhereTreenumerable<TSource, TOuterResult, ComposedResultSelector<TSource, TResult, TOuterResult, TResultSelector, TOuterSelector>>(
        _Source,
