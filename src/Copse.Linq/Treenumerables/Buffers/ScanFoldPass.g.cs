...
namespace Copse.Linq.Treenumerables
{
  ...
  {
    public ScanFoldPass(
      Func<ScanBuildRequest<TSource, TAccumulate>, (ScanFoldArtifacts<TSource, TAccumulate> Artifacts, NodeAccumulation<TSource, TAccumulate>[] FusedPairProducts)> build)
    {
      _Build = build;
    }

    private Func<ScanBuildRequest<TSource, TAccumulate>, (ScanFoldArtifacts<TSource, TAccumulate> Artifacts, NodeAccumulation<TSource, TAccumulate>[] FusedPairProducts)> _Build;
    ...
    /// </summary>
    public (ScanFoldArtifacts<TSource, TAccumulate> Artifacts, NodeAccumulation<TSource, TAccumulate>[] FusedPairProducts, bool WriterRan) Ensure(
      ScanBuildRequest<TSource, TAccumulate> request)
    {
      if (_Build != null)
      {
        (_Artifacts, _FusedPairProducts) = _Build(request);
