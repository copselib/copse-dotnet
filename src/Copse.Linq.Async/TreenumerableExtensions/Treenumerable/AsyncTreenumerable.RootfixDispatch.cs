...
namespace Copse.Linq
{
  public static partial class AsyncTreenumerable
  {
    ...
    public static IAsyncTreenumerableBuffer<NodeArrival<TNode, TDispatch>> RootfixDispatch<TNode, TDispatch>(
      ...
      Action<TDispatch, DispatchTargets<TNode, TDispatch>> survey)
      => new AsyncTreenumerableBuffer<NodeArrival<TNode, TDispatch>>(
        AsyncTree.Lazy(() => PreorderRootfixDispatch(source, PerRootSurvey<TNode, TDispatch>((node, _) => rootNodeSelector(node)), survey)), BufferLayout.Preorder);
    ...
    public static IAsyncTreenumerableBuffer<NodeArrival<TNode, TDispatch>> RootfixDispatch<TNode, TDispatch>(
      ...
      Action<TDispatch, DispatchTargets<TNode, TDispatch>> survey)
      => new AsyncTreenumerableBuffer<NodeArrival<TNode, TDispatch>>(
        AsyncTree.Lazy(() => PreorderRootfixDispatch(source, PerRootSurvey<TNode, TDispatch>(rootNodeSelector), survey)), BufferLayout.Preorder);
    ...
    public static IAsyncTreenumerableBuffer<NodeArrival<TNode, TDispatch>> RootfixDispatch<TNode, TDispatch>(
      ...
      Action<TDispatch, DispatchTargets<TNode, TDispatch>> survey)
      => new AsyncTreenumerableBuffer<NodeArrival<TNode, TDispatch>>(
        AsyncTree.Lazy(() => PreorderRootfixDispatchBreadthFirstSource(source, PerRootSurvey<TNode, TDispatch>(rootNodeSelector), survey)), BufferLayout.Preorder);
    ...
    // transpose).
    private static IAsyncTreenumerable<NodeArrival<TNode, TDispatch>> PreorderRootfixDispatch<TNode, TDispatch>(
      IAsyncDepthFirstTreenumerable<TNode> source,
      Action<DispatchTargets<TNode, TDispatch>> rootFamilySurvey,
      Action<TDispatch, DispatchTargets<TNode, TDispatch>> survey)
    {
      var dispatched = new AsyncLazyPreorderStore<NodeArrival<TNode, TDispatch>>(
        () => BuildRootfixDispatchAsync(source, rootFamilySurvey, survey));

      return new AsyncPreorderTreenumerable<NodeArrival<TNode, TDispatch>, AsyncLazyPreorderStore<NodeArrival<TNode, TDispatch>>>(dispatched);
    }

    private static IAsyncTreenumerable<NodeArrival<TNode, TDispatch>> PreorderRootfixDispatchBreadthFirstSource<TNode, TDispatch>(
    ...
    private static async ValueTask<AsyncPreorderArrayStore<NodeArrival<TNode, TDispatch>>> BuildRootfixDispatchFromBreadthFirstAsync<TNode, TDispatch>(
      IAsyncBreadthFirstTreenumerable<TNode> source,
      Action<DispatchTargets<TNode, TDispatch>> rootFamilySurvey,
      Action<TDispatch, DispatchTargets<TNode, TDispatch>> survey)
    {
    ...
    // decoration.
    private static async ValueTask<AsyncPreorderArrayStore<NodeArrival<TNode, TDispatch>>> BuildRootfixDispatchAsync<TNode, TDispatch>(
      IAsyncDepthFirstTreenumerable<TNode> source,
      Action<DispatchTargets<TNode, TDispatch>> rootFamilySurvey,
      Action<TDispatch, DispatchTargets<TNode, TDispatch>> survey)
    {
      ...
      return new AsyncPreorderArrayStore<NodeArrival<TNode, TDispatch>>(results, subtreeSizes);
    }
    ...
    private static async ValueTask<(TNode[] Values, int[] SubtreeSizes, TDispatch[] Arrivals)> RunRootfixDispatchPassAsync<TNode, TDispatch>(
      IAsyncDepthFirstTreenumerable<TNode> source,
      Action<DispatchTargets<TNode, TDispatch>> rootFamilySurvey,
      Action<TDispatch, DispatchTargets<TNode, TDispatch>> survey)
    {
