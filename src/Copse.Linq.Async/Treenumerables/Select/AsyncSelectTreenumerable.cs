...
namespace Copse.Linq.Treenumerables
{
  ...
  public sealed partial class AsyncSelectTreenumerable<TSource, TResult> : IAsyncSelectWhereTreenumerable<TResult>
  {
    ...
    IAsyncTreenumerable<TOuterResult> IAsyncSelectWhereTreenumerable<TResult>.ComposePositional<TOuterResult>(Func<NodeAndPosition<TResult>, TOuterResult> selector)
    ...
    IAsyncTreenumerable<TOuterResult> IAsyncSelectWhereTreenumerable<TResult>.Compose<TOuterResult>(Func<NodeAndPosition<TResult>, TOuterResult> selector)
    {
    ...
    // filter driver.
    IAsyncTreenumerable<TResult> IAsyncSelectWhereTreenumerable<TResult>.ComposePruneDescendantsWhere(Func<NodeAndPosition<TResult>, bool> predicate)
    {
