...
namespace Copse.Linq.Async.Treenumerables
{
  ...
  internal sealed partial class AsyncSelectBreadthFirstTreenumerable<TSource, TResult> : IAsyncSelectWhereBreadthFirstTreenumerable<TResult>
  {
    ...
    internal AsyncSelectBreadthFirstTreenumerable(
      IAsyncBreadthFirstTreenumerable<TSource> source,
    ...
    IAsyncBreadthFirstTreenumerable<TOuterResult> IAsyncSelectWhereBreadthFirstTreenumerable<TResult>.Compose<TOuterResult>(Func<NodeContext<TResult>, TOuterResult> selector)
    {
    ...
    {
      return new AsyncSelectPruneAfterBreadthFirstTreenumerable<TSource, TResult, ComposedResultSelector<TSource, TResult, TResult, SelectResultSelector<TSource, TResult>, PruneAfterResultSelector<TResult>>>(
        _Source,
    ...
    IAsyncBreadthFirstTreenumerable<TOuterResult> IAsyncSelectWhereBreadthFirstTreenumerable<TResult>.Compose<TOuterResult>(
    ...
    IAsyncBreadthFirstTreenumerable<TOuterResult> IAsyncSelectWhereBreadthFirstTreenumerable<TResult>.Compose<TOuterResult, TOuterSelector>(
      TOuterSelector outerSelector,
      bool relabels)
      => ComposeCore<TOuterResult, TOuterSelector>(outerSelector, relabels);

    private IAsyncBreadthFirstTreenumerable<TOuterResult> ComposeCore<TOuterResult, TOuterSelector>(
      TOuterSelector outerSelector,
      bool relabels)
