...
namespace Copse.Linq.Treenumerables
{
  ...
  internal interface IAsyncSelectWhereBreadthFirstTreenumerable<TNode>
    ...
    IAsyncBreadthFirstTreenumerable<TOuterResult> Compose<TOuterResult>(Func<NodeAndPosition<TNode>, TOuterResult> selector);
    ...
    IAsyncBreadthFirstTreenumerable<TOuterResult> ComposePositional<TOuterResult>(Func<NodeAndPosition<TNode>, TOuterResult> selector);
    ...
    IAsyncBreadthFirstTreenumerable<TNode> ComposePruneDescendantsWhere(Func<NodeAndPosition<TNode>, bool> predicate);
  }
}
