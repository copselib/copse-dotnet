...
namespace Copse.Linq.Treenumerables
{
  ...
  internal interface IAsyncSelectWhereDepthFirstTreenumerable<TNode>
    ...
    IAsyncDepthFirstTreenumerable<TOuterResult> Compose<TOuterResult>(Func<NodeAndPosition<TNode>, TOuterResult> selector);
    ...
    IAsyncDepthFirstTreenumerable<TOuterResult> ComposePositional<TOuterResult>(Func<NodeAndPosition<TNode>, TOuterResult> selector);
    ...
    IAsyncDepthFirstTreenumerable<TNode> ComposePruneDescendantsWhere(Func<NodeAndPosition<TNode>, bool> predicate);
  }
}
