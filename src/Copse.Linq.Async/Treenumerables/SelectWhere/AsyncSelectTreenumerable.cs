...
namespace Copse.Linq.Async.Treenumerables
{
  ...
  public sealed partial class AsyncSelectTreenumerable<TSource, TResult> : IAsyncSelectWhereTreenumerable<TResult>
  {
    ...
    bool IAsyncSelectWhereTreenumerable<TResult>.Relabels => false;
    ...
    IAsyncTreenumerable<TOuterResult> IAsyncSelectWhereTreenumerable<TResult>.Compose<TOuterResult>(
