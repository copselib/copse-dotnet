...
namespace Copse.Linq.Treenumerables
{
      ...
      IAsyncPruneDescendantsWhereTreenumerable<TNode>
  {
    ...
    IAsyncTreenumerable<TOuterResult> Compose<TOuterResult>(Func<NodeAndPosition<TNode>, TOuterResult> selector);
    ...
    IAsyncTreenumerable<TOuterResult> ComposePositional<TOuterResult>(Func<NodeAndPosition<TNode>, TOuterResult> selector);

    IAsyncTreenumerable<TOuterResult> ComposePositional<TOuterResult, TOuterSelector>(
      TOuterSelector outerSelector,
      bool relabels)
      where TOuterSelector : struct, IAsyncResultSelector<TNode, TOuterResult>;
    ...
    IAsyncTreenumerable<TNode> ComposePruneDescendantsWhere(Func<NodeAndPosition<TNode>, bool> predicate);
  }
}
