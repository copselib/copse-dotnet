...
namespace Copse.Linq.Async.Treenumerables
{
  ...
  internal interface IAsyncSelectPruneAfterBreadthFirstTreenumerable<TNode> : IAsyncBreadthFirstTreenumerable<TNode>
  {
    ...
    IAsyncBreadthFirstTreenumerable<TOuterResult> ComposeRejecting<TOuterResult, TOuterSelector>(
