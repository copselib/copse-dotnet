...
namespace Copse.Linq.Async.Treenumerables
{
    ...
    where TResultSelector : struct, IResultSelector<TSource, TResult>
  {
    ...
    public IAsyncBreadthFirstTreenumerable<TOuterResult> ComposePositional<TOuterResult, TOuterSelector>(
      ...
      bool relabels)
      where TOuterSelector : struct, IResultSelector<TResult, TOuterResult>
      => new AsyncSelectWhereBreadthFirstTreenumerable<TResult, TOuterResult, TOuterSelector>(this, outerSelector, relabels);
    ...
    public IAsyncBreadthFirstTreenumerable<TResult> ComposePruneAfter(Func<NodeContext<TResult>, bool> predicate)
      => new AsyncPruneAfterBreadthFirstTreenumerable<TResult>(this, predicate);
  }
}
