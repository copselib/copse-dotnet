...
namespace Copse.Linq
{
  ...
  /// </summary>
  internal sealed partial class AsyncPruneDescendantsWhereBreadthFirstTreenumerable<TNode> : IAsyncSelectWhereBreadthFirstTreenumerable<TNode>
  {
    /// <summary>Wraps <paramref name="source"/> with a prune-after predicate.</summary>
    public AsyncPruneDescendantsWhereBreadthFirstTreenumerable(
    ...
    internal AsyncPruneDescendantsWhereBreadthFirstTreenumerable(
      IAsyncBreadthFirstTreenumerable<TNode> source,
    ...
    IAsyncBreadthFirstTreenumerable<TOuterResult> IAsyncSelectWhereBreadthFirstTreenumerable<TNode>.ComposePositional<TOuterResult>(Func<NodeAndPosition<TNode>, TOuterResult> selector)
    ...
    IAsyncBreadthFirstTreenumerable<TOuterResult> IAsyncSelectWhereBreadthFirstTreenumerable<TNode>.Compose<TOuterResult, TOuterSelector>(
      ...
      bool relabels)
    {
      return new AsyncSelectWhereBreadthFirstTreenumerable<TNode, TOuterResult, AsyncComposedResultSelector<TNode, TNode, TOuterResult, AsyncPruneDescendantsWhereResultSelector<TNode>, TOuterSelector>>(
        _Source,
    ...
    IAsyncBreadthFirstTreenumerable<TNode> IAsyncSelectWhereBreadthFirstTreenumerable<TNode>.ComposePruneDescendantsWhere(Func<NodeAndPosition<TNode>, bool> outerPredicate)
    {
      return new AsyncPruneDescendantsWhereBreadthFirstTreenumerable<TNode>(
    ...
    // filter driver.
    IAsyncBreadthFirstTreenumerable<TOuterResult> IAsyncSelectWhereBreadthFirstTreenumerable<TNode>.Compose<TOuterResult>(Func<NodeAndPosition<TNode>, TOuterResult> selector)
    {
      return new AsyncSelectPruneDescendantsWhereBreadthFirstTreenumerable<TNode, TOuterResult>(
