...
namespace Copse.Linq.Async.Treenumerables
{
  ...
  internal sealed partial class AsyncPruneDescendantsWhereBreadthFirstTreenumerable<TNode> : IAsyncSelectWhereBreadthFirstTreenumerable<TNode>
  {
    ...
    IAsyncBreadthFirstTreenumerable<TOuterResult> IAsyncSelectWhereBreadthFirstTreenumerable<TNode>.Compose<TOuterResult, TOuterSelector>(
      ...
      bool relabels)
    {
      return new AsyncSelectWhereBreadthFirstTreenumerable<TNode, TOuterResult, ComposedResultSelector<TNode, TNode, TOuterResult, PruneDescendantsWhereResultSelector<TNode>, TOuterSelector>>(
        _Source,
