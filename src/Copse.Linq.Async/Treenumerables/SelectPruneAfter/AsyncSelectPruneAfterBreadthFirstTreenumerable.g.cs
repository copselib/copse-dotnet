...
namespace Copse.Linq.Async.Treenumerables
{
  ...
  internal sealed partial class AsyncSelectPruneAfterBreadthFirstTreenumerable<TSource, TResult, TResultSelector> : IAsyncSelectWhereBreadthFirstTreenumerable<TResult>
    where TResultSelector : struct, IResultSelector<TSource, TResult>
  {
    ...
    {
      return new AsyncSelectPruneAfterBreadthFirstTreenumerable<TSource, TOuterResult, ComposedResultSelector<TSource, TResult, TOuterResult, TResultSelector, SelectResultSelector<TResult, TOuterResult>>>(
        _Source,
    ...
    {
      return new AsyncSelectPruneAfterBreadthFirstTreenumerable<TSource, TResult, ComposedResultSelector<TSource, TResult, TResult, TResultSelector, PruneAfterResultSelector<TResult>>>(
        _Source,
