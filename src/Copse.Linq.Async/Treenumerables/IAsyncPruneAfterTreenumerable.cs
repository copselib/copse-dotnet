...
namespace Copse.Linq.Async.Treenumerables
{
  ...
  /// </summary>
  public interface IAsyncPruneAfterTreenumerable<TNode> : IAsyncTreenumerable<TNode>
  {
    /// <summary>
    ...
    /// </summary>
    IAsyncPruneAfterTreenumerable<TNode> ComposePruneAfter(Func<TNode, bool> predicate);
  }
}
