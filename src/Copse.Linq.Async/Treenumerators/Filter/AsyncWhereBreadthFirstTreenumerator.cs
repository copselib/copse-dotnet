...
namespace Copse.Linq.Async
{
  ...
  /// async methods (CS8177). <c>Front</c> ref-returns the same slot on each call, so this is
  ...
  /// </summary>
  internal sealed class AsyncWhereBreadthFirstTreenumerator<TInner, TNode, TResultSelector>
