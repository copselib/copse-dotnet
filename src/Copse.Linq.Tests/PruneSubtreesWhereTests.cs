...
{
  [TestClass]
  public class PruneSubtreesWhereTests
  {
    static PruneSubtreesWhereTests()
    {
      ...
      new TreeTestDefinition[]
      {
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            new TestScenario
            {
              ...
              TreenumerableMap = treenumerable => treenumerable.PruneSubtreesWhere(_ => true),
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            new TestScenario
            {
              ...
              TreenumerableMap = treenumerable => treenumerable.PruneSubtreesWhere(visit => false),
            ...
            new TestScenario
            {
              ...
              TreenumerableMap = treenumerable => treenumerable.PruneSubtreesWhere((n, position) => position.Depth == 2),
            ...
            {
              NodeTraversalStrategiesSelector = visit => visit.Position.Depth == 0 ? NodeTraversalStrategies.SkipNode : NodeTraversalStrategies.TraverseAll,
              TreenumerableMap = treenumerable => treenumerable.PruneSubtreesWhere((n, position) => position.Depth == 1),
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            {
              NodeTraversalStrategiesSelector = visit => NodeTraversalStrategies.TraverseAll,
              TreenumerableMap = treenumerable => treenumerable.PruneSubtreesWhere(n => n == "b"),
            ...
            {
              NodeTraversalStrategiesSelector = visit => NodeTraversalStrategies.TraverseAll,
              TreenumerableMap = treenumerable => treenumerable.PruneSubtreesWhere(n => n == "c"),
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            {
              NodeTraversalStrategiesSelector = visit => NodeTraversalStrategies.TraverseAll,
              TreenumerableMap = treenumerable => treenumerable.PruneSubtreesWhere((n, position) => position.SiblingIndex == 0),
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            {
              NodeTraversalStrategiesSelector = visit => visit.Position.Depth == 1 ? NodeTraversalStrategies.SkipNode : NodeTraversalStrategies.TraverseAll,
              TreenumerableMap = treenumerable => treenumerable.PruneSubtreesWhere((n, position) => position.Depth == 1 && position.SiblingIndex == 1),
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            {
              NodeTraversalStrategiesSelector = visit => visit.Node == "b" ? NodeTraversalStrategies.SkipNode : NodeTraversalStrategies.TraverseAll,
              TreenumerableMap = treenumerable => treenumerable.PruneSubtreesWhere(n => n == "a"),
            ...
            {
              NodeTraversalStrategiesSelector = visit => visit.Node == "b" ? NodeTraversalStrategies.SkipNode : NodeTraversalStrategies.TraverseAll,
              TreenumerableMap = treenumerable => treenumerable.PruneSubtreesWhere(n => n == "d"),
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            {
              NodeTraversalStrategiesSelector = visit => NodeTraversalStrategies.TraverseAll,
              TreenumerableMap = treenumerable => treenumerable.PruneSubtreesWhere((n, position) => position.SiblingIndex == 1),
    ...
    public void PruneSubtreesWhere_BreadthFirst(
      string treeString,
    ...
    [TestMethod]
    [DynamicData(nameof(GetTestData), DynamicDataSourceType.Method, DynamicDataDisplayName = nameof(GetTestDisplayName))]
    public void PruneSubtreesWhere_DepthFirst(
      string treeString,
      string testDescription,
      int testIndex,
      int testScenarioIndex)
