...
{
  [TestClass]
  public class PruneDescendantsWhereTests
  {
    static PruneDescendantsWhereTests()
    {
      ...
      new TreeTestDefinition[]
      {
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            new TestScenario
            {
              ...
              TreenumerableMap = treenumerable => treenumerable.PruneDescendantsWhere(_ => true),
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            new TestScenario
            {
              ...
              TreenumerableMap = treenumerable => treenumerable.PruneDescendantsWhere((n, position) => position.Depth == 1),
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            {
              NodeTraversalStrategiesSelector = visit => visit.Position.Depth == 0 ? NodeTraversalStrategies.SkipNode : NodeTraversalStrategies.TraverseAll,
              TreenumerableMap = treenumerable => treenumerable.PruneDescendantsWhere((n, position) => position.Depth == 0),
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            new TestScenario
            {
              NodeTraversalStrategiesSelector = visit => visit.Position.Depth == 0 ? NodeTraversalStrategies.PruneDescendants : NodeTraversalStrategies.TraverseAll,
              TreenumerableMap = treenumerable => treenumerable.PruneDescendantsWhere(_ => false),
            ...
            new TestScenario
            {
              NodeTraversalStrategiesSelector = visit => visit.Node == "c" ? NodeTraversalStrategies.PruneSubtree : NodeTraversalStrategies.TraverseAll,
              TreenumerableMap = treenumerable => treenumerable.PruneDescendantsWhere(_ => false),
        ...
        new TreeTestDefinition
        {
          ...
          TestScenarios = new List<TestScenario>
          {
            ...
            {
              NodeTraversalStrategiesSelector = visit => visit.Node == "a" ? NodeTraversalStrategies.SkipNode : NodeTraversalStrategies.TraverseAll,
              TreenumerableMap = treenumerable => treenumerable.PruneDescendantsWhere(n => n == "b"),
    ...
    public void PruneDescendantsWhere_BreadthFirst(
      string treeString,
    ...
    [TestMethod]
    [DynamicData(nameof(GetTestData), DynamicDataSourceType.Method, DynamicDataDisplayName = nameof(GetTestDisplayName))]
    public void PruneDescendantsWhere_DepthFirst(
      string treeString,
      string testDescription,
      int testIndex,
      int testScenarioIndex)
